  ...
  return (
    <nav className="navbar navbar-expand-lg blur border-radius-sm top-0 z-index-3 shadow position-sticky py-3 start-0 end-0">
      <div className="container px-1">
        <a className="navbar-brand container ms-lg-0 flex" href="/">
            <img src="/logo-sm.png" alt="logo" className='icon-sm'/>
            <h4 className="pad-left">Ellek's Store</h4>
        </a>
        ...
        <div className="collapse navbar-collapse" id="navigation">
          <ul className="navbar-nav ms-auto">
            ...
            {/*    <li><a className="dropdown-item" href="/astro-ecommerce/all-products/">All Products</a></li>*/}
            {/*  </ul>*/}
            {/*</li>*/}
            {/*<li className="nav-item">*/}
